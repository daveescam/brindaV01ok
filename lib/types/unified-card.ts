...
export function mapToneToGenre(tone: ToneSubtype): string {
...
export function generateSocialTrigger(category: ChallengeCategory, emotionalTier: string): string {
...
export function mapToVerificationType(format: InteractionFormat): VerificationType {
...
export function generateReward(experienceType: ExperienceType, emotionalTier: string, brandId?: string): string {
...
export function mapEmotionalTierToDifficulty(tier: string): "easy" | "medium" | "hard" {
  switch (tier) {
    case "mild":
      return "easy"
    case "intense":
...
// Función para obtener un array de todas las categorías de reto
export function getAllChallengeCategories(): ChallengeCategory[] {
  return [
    "karaoke",
    "visual",
    "misterioso",
...
// Función para obtener un array de todos los formatos de interacción
export function getAllInteractionFormats(): InteractionFormat[] {
  return [
    "canto_memoria",
    "vocal_improvisacion",
    "canto_tempo",
...
// Función para obtener un array de todos los subtipos de tono
export function getAllToneSubtypes(): ToneSubtype[] {
  return [
    "acusatorio",
    "metalero",
    "urbano",
...
// Función para obtener un array de todos los tipos de experiencia
export function getAllExperienceTypes(): ExperienceType[] {
  return ["campaign", "multi_table", "group", "individual"]
}

// Función para obtener un array de todos los tipos de reto
export function getAllChallengeTypes(): ChallengeType[] {
  return ["individual", "duet", "group"]
}

// Función para obtener un array de todos los niveles emocionales
export function getAllEmotionalTiers(): ("mild" | "intense" | "chaotic")[] {
  return ["mild", "intense", "chaotic"]
}
